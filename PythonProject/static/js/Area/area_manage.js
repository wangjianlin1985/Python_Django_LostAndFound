...
function initAreaManageTool() {
	area_manage_tool = {
		...
		search: function() {
			$("#area_manage").datagrid("options").queryParams=queryParams; 
			$("#area_manage").datagrid("load");
		},
		exportExcel: function() {
			$("#areaQueryForm").form({
			    url:"/Area/OutToExcel?csrfmiddlewaretoken" + $('input[name="csrfmiddlewaretoken"]').val(),
			});
			//提交表单
